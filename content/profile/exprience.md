...
### [클래스101](https://class101.net/)
  ...
  >
  > 클래스101 B2B 서비스 개발 담당
  >> 참여 기간: 2021.07 ~ 진행중\
  >> 담당업무: 프론트 엔드 개발(React, Typescript, Apollo, Graphql)\
  >> 업무 내용: 클래스 101 기업 고객 전용 서비스 개발\
  >> 성과: **B2B 서비스 매출 증가 기여**
  >
  ...
  >> 업무 내용: 수동으로 입력해야하는 쿠폰명을 설정한 조건에 맞게 자동생성되게함\
  >> **성과: 2021.06 프로모션 이벤트 및 향후 서비스에서 쿠폰 관련 생산성을 증가시켜 매출 증가에 기여함**
  >
  > 클래스 101 웹 성능 최적화
  >> 참여 기간: 2021.04 ~ 2021.05\
  >> 담당업무: 프론트 엔드 개발(React, Typescript)\
  >> 업무내용: web vitals, light house, data dog을 지표로 서비스 성능을 개선하는 작업\
