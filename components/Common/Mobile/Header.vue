<template>
  <div class="headerWrap">
    <div class="content">
      ...
      ></button>
      <button v-else class="menu back" @click="$router.back()"></button>
      <div class="title">
        ...
        <nav class="pages">
          <ul>
            <li @click="close">
              ...
              >
                <i
                  v-if="pageName.indexOf('profile') === -1"
                  class="icon profile"
                ></i>
            ...
            <li @click="close">
              ...
              >
                <i
                  v-if="pageName.indexOf('travel') === -1"
                  class="icon travel"
                ></i>
    ...
    <transition name="fade">
      <div v-if="showNavigation" @click="close" class="mask"></div>
    </transition>
  </div>
</template>
  ...
  computed: {
    pageDepth() {
      return this.$route && this.$route.path
        ? this.$route.path.split('/').filter((v) => v !== '')
        : [];
    },
    pageName() {
      return this.$route && this.$route.path
